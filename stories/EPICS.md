...
| Story | Titel | Geschat | Status |
|-------|-------|---------|--------|
| C2-01 | Content voor concept-INTRO knopen | ~8 bestanden | todo |
| C2-02 | Content voor declinatie-paradigma's | ~6 bestanden | todo |
| C2-03 | Content voor werkwoord-paradigma's | ~8 bestanden | todo |
