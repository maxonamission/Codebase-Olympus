...
| F2-03 | Struikelpunten-overzicht per leerling | F2-01 | done |
...
| M1-02 | Misconceptie-attribuut + Lego-vertaler-detectie | M1-01, M1-04 | backlog |
| M1-03 | Bijspijkerroute — methode-en-hoofdstuk-gestuurde catch-up | E1 | backlog |
| M1-04 | Vertaal-integratielaag — eerste I-VERT-knopen (enabler M1-02) | M1-01 | doing |
...
| L1-02 | Baseline-intakemeting en effectgrootte-rapportage | L1-01 | done |
| L1-03 | A/B-experiment- en variant-framework | L1-01, L1-02 | done |
...
| L2-03 | Learner-niveau parameters (individuele leersnelheid) | L2-02 | done |
