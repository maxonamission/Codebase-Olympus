...
## Acceptatiecriteria
- [ ] Dekking LAT-G: van 25 % naar ≥ 80 %, gemeten via F1-11 script
- [ ] Per toegevoegde markdown: metadata-frontmatter conform bestaand patroon (`knoop_id`, `laatst_bijgewerkt`, `auteur`)
- [ ] Paradigma-tabellen in markdown-tabelsyntax (GFM) — werken met react-markdown + remark-gfm
- [ ] Geen markdown zonder matching knoop-ID
- [ ] Validator-check uit F1-06 groen voor alle nieuwe files
