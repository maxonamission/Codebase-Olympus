# Story F1-01: Frontend ScaffoldingPanel — render scaffolding_content als markdown
...
## Acceptatiecriteria
- [ ] Geen breaking changes in bestaande models/API
- [ ] Alle bestaande tests blijven groen
- [ ] Nieuwe component (`ScaffoldingPanel.jsx`) heeft eigen component-smoke-test
- [ ] Markdown wordt als markdown gerenderd (tabellen, headings, fett/cursief), niet als platte tekst
- [ ] Panel wordt alleen getoond wanneer `scaffolding_content` aanwezig is
