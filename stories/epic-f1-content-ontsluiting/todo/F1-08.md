# Story F1-08: Cultuurknopen oefenbaar maken
...
## Acceptatiecriteria
- [ ] Elke SHA-C-knoop heeft óf minstens één item óf een korte markdown met een `self_assess`-prompt
- [ ] Minstens één oefentype per cultuurknoop dat door de scheduling-engine als kandidaat wordt opgepikt (validatie: `export_graph_stats.py` toont item-count > 0)
- [ ] Items gebruiken bestaande item-types (`herkenning` met MC-opties, of `self_assess` met modelantwoord)
- [ ] Geen breaking changes in models
