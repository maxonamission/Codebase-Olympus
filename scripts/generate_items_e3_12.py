#!/usr/bin/env python3
"""E3-12 supplementary items: 5 GRC-G-SYNT-*-FUNCTIE knopen.

Deze knopen bleven over na E3-01..E3-11 zonder items. Deze story (E3-12)
    ...
    items["GRC-G-SYNT-NOM-FUNCTIE"] = [
        {
            ...
            "knoop_ids": ["GRC-G-SYNT-NOM-FUNCTIE"],
            "type": "herkenning",
            "richting": "receptief",
        ...
        },
        {
            ...
            "antwoord": ["naamwoordelijk deel van het gezegde", "predicaatsnomen"],
    ...
    items["GRC-G-SYNT-GEN-FUNCTIE"] = [
        {
            ...
            "knoop_ids": ["GRC-G-SYNT-GEN-FUNCTIE"],
            "type": "herkenning",
            "richting": "receptief",
            "moeilijkheid_initieel": -0.3,
            "discriminatie_initieel": 1.0,
        ...
        },
        {
            ...
            "antwoord": ["partitief", "genitivus partitivus"],
    ...
    items["GRC-G-SYNT-DAT-FUNCTIE"] = [
        {
            ...
            "knoop_ids": ["GRC-G-SYNT-DAT-FUNCTIE"],
            "type": "herkenning",
            "richting": "receptief",
            "moeilijkheid_initieel": -0.3,
            "discriminatie_initieel": 1.0,
        ...
        },
        {
            ...
            "antwoord": ["middel", "dativus van middel", "instrumentalis"],
        ...
        },
        {
            ...
            "antwoord": ["bezitter", "bezitter bij εἶναι", "dativus possessivus"],
    ...
    items["GRC-G-SYNT-ACC-FUNCTIE"] = [
        {
            ...
            "knoop_ids": ["GRC-G-SYNT-ACC-FUNCTIE"],
            "type": "herkenning",
            "richting": "receptief",
            "moeilijkheid_initieel": -0.3,
            "discriminatie_initieel": 1.0,
            ...
            "feedback": "De accusativus is de naamval van het lijdend voorwerp, richting, tijdsduur en betrekking (respectus).",
            "bron": "handmatig",
        },
        {
        ...
        },
        {
            ...
            "antwoord": ["tijdsduur", "accusativus van tijdsduur"],
        ...
        },
        {
            ...
            "antwoord": ["betrekking", "accusativus van respectus", "respectus"],
    ...
    items["GRC-G-SYNT-VOC-FUNCTIE"] = [
        {
            ...
            "knoop_ids": ["GRC-G-SYNT-VOC-FUNCTIE"],
            "type": "herkenning",
            "richting": "receptief",
            ...
            "antwoord": ["aanspreekvorm", "iemand direct aanspreken"],
        ...
        },
        {
            ...
            "antwoord": ["παῖ", "het kind", "de jongen"],
        ...
        },
        {
            ...
            "antwoord": ["2e declinatie masculinum op -ος", "2e declinatie op -ος"],
