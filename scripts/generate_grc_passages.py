...
BATCH_3: list[dict] = [
    passage(
        11, "De mens schreef", 11, "impf_augment",
        zinnen=[
            zin("ὁ ἄνθρωπος ἔγραφεν.", "De mens schreef.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("ἄνθρωπος", "ἄνθρωπος", "nom.sg.m — 2e decl.", "mens"),
                w("ἔγραφεν", "γράφω", "impf.ind.act. 3sg — -ω verb", "schreef"),
            ]),
            zin("ὁ δοῦλος τὸν ἵππον ἦγεν.", "De slaaf leidde het paard.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("δοῦλος", "δοῦλος", "nom.sg.m — 2e decl.", "slaaf"),
                w("τὸν", "ὁ/ἡ/τό", "acc.sg.m — lidwoord", "het"),
                w("ἵππον", "ἵππος", "acc.sg.m — 2e decl.", "paard"),
            ...
            zin("ὁ στρατηγὸς τοὺς δούλους εἶχεν.", "De strateeg had de slaven.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("στρατηγὸς", "στρατηγός", "nom.sg.m — 2e decl.", "strateeg"),
                w("τοὺς", "ὁ/ἡ/τό", "acc.pl.m — lidwoord", "de"),
                w("δούλους", "δοῦλος", "acc.pl.m — 2e decl.", "slaven"),
        ...
        knoop_ids=[
            "GRC-G-MORF-IMPF-INTRO", "GRC-G-MORF-IMPF-THEM",
            "GRC-G-MORF-AUGMENT",
            "GRC-G-MORF-NOM-D2", "GRC-G-MORF-ACC-D2",
            "GRC-G-MORF-LIDW-VERBG",
            "GRC-V-F01-ANTHRO", "GRC-V-F01-GRAPHO", "GRC-V-F02-DOULOS",
            "GRC-V-F01-HIPPOS", "GRC-V-F01-AGO", "GRC-V-F01-STRTGS",
            "GRC-V-F01-ECHO", "GRC-V-F01-ARTIC",
        ],
    ),
    passage(
        12, "Op de markt", 12, "prep_impf_eimi",
        zinnen=[
            zin("ὁ ἄνθρωπος ἐν τῇ ἀγορᾷ ἦν.", "De mens was op de markt.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("ἄνθρωπος", "ἄνθρωπος", "nom.sg.m — 2e decl.", "mens"),
            ...
            zin("ὁ δοῦλος εἰς τὴν ἀγορὰν τὸν ἵππον ἦγεν.", "De slaaf leidde het paard naar de markt.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("δοῦλος", "δοῦλος", "nom.sg.m — 2e decl.", "slaaf"),
            ...
            zin("ὁ στρατηγὸς ἐκ τῆς χώρας τοὺς δούλους ἔπεμπεν.", "De strateeg stuurde de slaven uit het land.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("στρατηγὸς", "στρατηγός", "nom.sg.m — 2e decl.", "strateeg"),
        ...
        knoop_ids=[
            "GRC-G-MORF-IMPF-INTRO", "GRC-G-MORF-IMPF-THEM",
            "GRC-G-MORF-IMPF-EIMI", "GRC-G-MORF-AUGMENT",
            "GRC-G-MORF-DAT-D1", "GRC-G-MORF-ACC-D1",
            "GRC-G-MORF-GEN-D1", "GRC-G-MORF-ACC-D2",
            "GRC-G-SYNT-PREP-INTRO", "GRC-G-SYNT-PREP-DAT",
            "GRC-G-SYNT-PREP-ACC", "GRC-G-SYNT-PREP-GEN",
            "GRC-V-F01-ANTHRO", "GRC-V-F01-EN", "GRC-V-F02-AGORA",
            "GRC-V-F01-EIMI", "GRC-V-F02-DOULOS", "GRC-V-F01-EIS",
            "GRC-V-F01-HIPPOS", "GRC-V-F01-AGO", "GRC-V-F01-STRTGS",
            "GRC-V-F01-EK", "GRC-V-F02-CHORA", "GRC-V-F01-PEMPO",
            "GRC-V-F01-ARTIC",
        ],
    ),
    passage(
        13, "Het kind en de vader", 13, "decl3_intro",
        zinnen=[
            zin("ὁ παῖς ἀγαθός ἐστιν.", "Het kind is goed.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "het"),
                w("παῖς", "παῖς", "nom.sg.m — 3e decl.", "kind"),
                w("ἀγαθός", "ἀγαθός", "nom.sg.m — adj. D1/D2", "goed"),
                w("ἐστιν", "εἰμί", "praes.ind. 3sg", "is"),
            ]),
            zin("ὁ πατὴρ τὸν παῖδα ἄγει.", "De vader leidt het kind.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
            ...
            zin("ἡ πόλις καλή ἐστιν.", "De stad is mooi.", [
                w("ἡ", "ὁ/ἡ/τό", "nom.sg.f — lidwoord", "de"),
        ...
        knoop_ids=[
            "GRC-G-MORF-NOM-D3", "GRC-G-MORF-ACC-D3",
            "GRC-G-MORF-DECL3-INTRO", "GRC-G-MORF-DECL3-KONS",
            "GRC-G-MORF-PRAES-EIMI", "GRC-G-MORF-PRAES-THEM",
            "GRC-G-MORF-LIDW-INTRO",
            "GRC-G-MORF-ADJ-D12-2U", "GRC-G-SYNT-NOM-FUNCTIE",
            "GRC-V-F01-PAIS", "GRC-V-F01-AGATHO", "GRC-V-F01-EIMI",
            "GRC-V-F01-PATER", "GRC-V-F01-AGO", "GRC-V-F01-POLIS",
            "GRC-V-F01-KALOS", "GRC-V-F01-ARTIC",
        ],
    ),
    passage(
        14, "De strateeg stuurde soldaten", 14, "aor_sigma",
        zinnen=[
            zin("ὁ στρατηγὸς τοὺς δούλους ἔπεμψεν.", "De strateeg stuurde de slaven.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("στρατηγὸς", "στρατηγός", "nom.sg.m — 2e decl.", "strateeg"),
                w("τοὺς", "ὁ/ἡ/τό", "acc.pl.m — lidwoord", "de"),
                w("δούλους", "δοῦλος", "acc.pl.m — 2e decl.", "slaven"),
            ...
            zin("ὁ ἄνθρωπος λόγον ἔγραψεν.", "De mens schreef een rede.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("ἄνθρωπος", "ἄνθρωπος", "nom.sg.m — 2e decl.", "mens"),
                w("λόγον", "λόγος", "acc.sg.m — 2e decl.", "rede/woord"),
                w("ἔγραψεν", "γράφω", "aor.ind.act. 3sg — σ-aor.", "schreef"),
            ]),
            zin("ὁ πατὴρ τῷ παιδὶ δῶρον ἔπεμψεν.", "De vader stuurde het kind een geschenk.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("πατὴρ", "πατήρ", "nom.sg.m — 3e decl.", "vader"),
        ...
        knoop_ids=[
            "GRC-G-MORF-AOR-INTRO", "GRC-G-MORF-AOR-SIGMA",
            "GRC-G-MORF-AOR-UIT", "GRC-G-MORF-AUGMENT",
            "GRC-G-MORF-NOM-D2", "GRC-G-MORF-NOM-D3",
            "GRC-G-MORF-ACC-D2", "GRC-G-MORF-DAT-D3",
            "GRC-G-SYNT-AOR-ASPECT",
            "GRC-V-F01-STRTGS", "GRC-V-F02-DOULOS", "GRC-V-F01-PEMPO",
            "GRC-V-F01-ANTHRO", "GRC-V-F01-LOGOS", "GRC-V-F01-GRAPHO",
            "GRC-V-F01-PATER", "GRC-V-F01-PAIS", "GRC-V-F02-DORON",
            "GRC-V-F01-ARTIC",
        ],
    ),
    passage(
        15, "De slag", 15, "alles_gecombineerd",
        zinnen=[
            zin("ἡ μάχη δεινὴ ἦν.", "De slag was verschrikkelijk.", [
                w("ἡ", "ὁ/ἡ/τό", "nom.sg.f — lidwoord", "de"),
                w("μάχη", "μάχη", "nom.sg.f — 1e decl. (η-type)", "slag/strijd"),
                w("δεινὴ", "δεινός", "nom.sg.f — adj. D1/D2", "verschrikkelijk"),
                w("ἦν", "εἰμί", "impf.ind. 3sg", "was"),
            ]),
            zin("οἱ στρατιῶται ἐν τῇ χώρᾳ ἦσαν.", "De soldaten waren in het land.", [
                w("οἱ", "ὁ/ἡ/τό", "nom.pl.m — lidwoord", "de"),
            ...
            zin("ὁ στρατηγὸς τοὺς στρατιώτας εἰς τὴν πόλιν ἔπεμψεν.", "De strateeg stuurde de soldaten naar de stad.", [
                w("ὁ", "ὁ/ἡ/τό", "nom.sg.m — lidwoord", "de"),
                w("στρατηγὸς", "στρατηγός", "nom.sg.m — 2e decl.", "strateeg"),
                w("τοὺς", "ὁ/ἡ/τό", "acc.pl.m — lidwoord", "de"),
            ...
            zin("οἱ ἄνθρωποι ἐκ τῆς ἀγορᾶς ἔφευγον.", "De mensen vluchtten van de markt.", [
                w("οἱ", "ὁ/ἡ/τό", "nom.pl.m — lidwoord", "de"),
                w("ἄνθρωποι", "ἄνθρωπος", "nom.pl.m — 2e decl.", "mensen"),
        ...
        knoop_ids=[
            "GRC-G-MORF-NOM-D1", "GRC-G-MORF-NOM-D2", "GRC-G-MORF-NOM-D3",
            "GRC-G-MORF-ACC-D1", "GRC-G-MORF-ACC-D2", "GRC-G-MORF-ACC-D3",
            "GRC-G-MORF-GEN-D1", "GRC-G-MORF-DAT-D1",
            "GRC-G-MORF-DECL1-INTRO", "GRC-G-MORF-DECL1-MASC",
            "GRC-G-MORF-DECL1-ALFA", "GRC-G-MORF-DECL3-INTRO",
            "GRC-G-MORF-IMPF-INTRO", "GRC-G-MORF-IMPF-EIMI",
            "GRC-G-MORF-AOR-INTRO", "GRC-G-MORF-AOR-SIGMA",
            "GRC-G-MORF-AUGMENT", "GRC-G-MORF-NUMERUS-INTRO",
            "GRC-G-SYNT-PREP-INTRO", "GRC-G-SYNT-PREP-ACC",
            "GRC-G-SYNT-PREP-GEN", "GRC-G-SYNT-PREP-DAT",
            "GRC-V-F01-MACHE", "GRC-V-F01-DEINOS", "GRC-V-F01-EIMI",
            "GRC-V-F02-STRTTS", "GRC-V-F01-EN", "GRC-V-F02-CHORA",
            "GRC-V-F01-STRTGS", "GRC-V-F01-EIS", "GRC-V-F01-POLIS",
            "GRC-V-F01-PEMPO", "GRC-V-F01-ANTHRO", "GRC-V-F01-EK",
            "GRC-V-F02-AGORA", "GRC-V-F02-PHEUGO", "GRC-V-F01-ARTIC",
        ],
    ),
]
