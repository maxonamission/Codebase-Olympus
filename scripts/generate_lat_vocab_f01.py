#!/usr/bin/env python3
"""Generate Latin vocabulary F01 (top-100) nodes and save to JSON."""
...
WORDS = Path("data/vocab_sources/lat_f01_words.json")
...
DESC_TEMPLATES = {
    ...
    "noun_45": "Het zelfstandig naamwoord {lemma}, {gen}: {mean}. {decl}e declinatie. Frequentieband {band}.",
