...
Scope:  8 knopen rondom de 3e declinatie: DECL3-INTRO, DECL3-KONS,
    ...
    items["GRC-G-MORF-DECL3-INTRO"] = [
        {
            ...
            "knoop_ids": ["GRC-G-MORF-DECL3-INTRO"],
            "type": "herkenning",
            "richting": "receptief",
    ...
    items["GRC-G-MORF-DECL3-KONS"] = [
        {
            ...
            "knoop_ids": ["GRC-G-MORF-DECL3-KONS"],
            "type": "herkenning",
            "richting": "receptief",
            "moeilijkheid_initieel": 0.1,
    ...
    items["GRC-G-MORF-DECL3-PARAD"] = [
        {
            ...
            "knoop_ids": ["GRC-G-MORF-DECL3-PARAD"],
            ...
            "antwoord": "m. sg.: πᾶς, παντός, παντί, πάντα — f. sg.: πᾶσα, πάσης, πάσῃ, πᾶσαν — n. sg.: πᾶν, παντός, παντί, πᾶν — m./f./n. pl. zoals in grammatica.",
            ...
            "verwacht_resultaat": "3 × 2 × 5 = 30 vormen van πᾶς, met correcte accenten en zichtbare klankwetten (ντ voor σ valt weg).",
        },
        {
