...
ITEMS = [
    ...
    (
        "LAT-G-SYNT-NOM-FUNCTIE", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-ACC-FUNCTIE", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-GEN-FUNCTIE", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-DAT-FUNCTIE", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-ABL-FUNCTIE", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-ADJ-CONGR", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-PREP-ACC", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-PREP-ABL", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-OVEREENK", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-WRDVLG", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-ONTK", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-VRAAGZIN", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-ZINSDEEL-INTRO", "lat_grammatica_poc.json",
    ...
    (
        "LAT-G-SYNT-VOC-FUNCTIE", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-SUBJ", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-OBJDIR", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-OBJIND", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-PREP-IN", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-PREP-RICHT", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-PREP-TIJD", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-PREP-HERK", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-PREP-OVERIG", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-GEZEGDE", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-NWG", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-BIJV-BEP", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-BIJW-BEP", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-BEPVZ", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-HOOFDBIJ", "lat_grammatica_leerjaar1.json",
    ...
    (
        "LAT-G-SYNT-ACI-INTRO", "lat_grammatica_leerjaar1.json",
